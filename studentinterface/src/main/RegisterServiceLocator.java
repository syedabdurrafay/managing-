...
public class RegisterServiceLocator extends org.apache.axis.client.Service implements main.RegisterService {
    ...
    private java.lang.String Register_address = "http://localhost:8080/student_management_system/services/Register";
    ...
    public main.Register getRegister(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.RegisterSoapBindingStub _stub = new main.RegisterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Register.class.isAssignableFrom(serviceEndpointInterface)) {
                main.RegisterSoapBindingStub _stub = new main.RegisterSoapBindingStub(new java.net.URL(Register_address), this);
                _stub.setPortName(getRegisterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "RegisterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "Register"));
        }
